...
function Cv() {
    return (
        <article class="prose md:prose-lg lg:prose-xl mb-10">
            ...
            <div>
                <h4>Federación Venezolana de Fútbol, Freelance job
                    2021</h4>
                <p>
                    Creating a prototype of Landing page
            ...
            <div>
                ...
                <h4>
                    Clon de Mincraft | React Clone de Mincraft | React.
                    diciembre. 2022
                </h4>
                <p>

                    A minimal minecraft clone built with react, vite, threejs, and zustand. Using the three hooks built-in in its library link to repo: <a href="https://github.com/maikCyphlock/minecraft-react">https://github.com/maikCyphlock/minecraft-react</a>
                </p>
            </div>
            <div>
                <h4>
                ...
                <p>
                    This is an app made with Astro that gets data from the backend: <a href="https://github.com/maikCyphlock/dollar-ve-api">
                        https://github.com/maikCyphlock/dollar-ve-api </a> that scrapes and retrieves the data to Cloudflare workers and GitHub actions deploy the API every hour.
                </p>
                <p>
                    Link to the frontend repo: <a href="https://github.com/maikCyphlock/dollar-frontend-api">
